...
def test_login_and_generate_tokens():
    # Login
    v_response = requests.get(url="https://e2edemo.int-aws-us.webmethods.io/b2b/", headers=headers, allow_redirects=False)
    ...
    csrf = requests.get(url=csrfUrl, headers=headers, cookies=v_response.cookies, allow_redirects=False,
                        auth=HTTPBasicAuth('shanthi.marthala@softwareag.com', 'Siqa@1234'))
...
#test_login_and_generate_tokens("https://e2edemo.int-aws-us.webmethods.io/b2b/")